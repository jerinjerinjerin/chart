...
const Home = () => {
  ...
  const getMainChartOptions = () => ({
    ...
    grid3D: {
      ...
      viewControl: {
        ...
        zoomSensitivity: 1.5,
        alpha: 10,  // Adjust alpha angle
        beta: 20,   // Adjust beta angle
      },
    },
    xAxis3D: {
      type: "category",
    ...
    zAxis3D: {
      ...
      axisLabel: {
        formatter: "{value} ⭐",
        color: '#000', // Set z-axis labels color to black
      },
      splitLine: { show: false },
    },
    series: [
      {
        ...
        symbolSize: (value) => (value[2] * 10) + 10, // Adjust symbol size for better visibility
        itemStyle: {
        ...
        label: { // Adding labels to bubbles
          show: true,
          formatter: (params) => `${params.data[2].toFixed(2)} ⭐`,
          position: 'top', // Positioning the label on top of the bubble
          color: '#000', // Set bubble label color to black
          fontSize: 12,
        },
  ...
  return (
    <div className="flex flex-col justify-center items-center mt-10 text-black"> {/* Set text color to black */}
      <div className="mb-4">
...
/>
      ...
      {selectedData && (
        <div className="mt-4 text-center">
          <h3 className="font-semibold">Selected Data:</h3>
          <p>
