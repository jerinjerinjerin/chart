    ...
    series: [
      {
        ...
        type: "scatter3D",
        data: reviewData.map((rating, index) => [xLabels[index], rating, reviewCounts[index]]),
        symbolSize: (value) => value[2] * 3, // Bubble size based on review count
        itemStyle: {
    ...
    <div className="flex flex-col justify-center items-center mt-10">
      ...
      {selectedData && (
        <div className="mt-4">
          ...
          <p>Review Count: {selectedData.count}</p>
        </div>
      )}
    </div>
  );
